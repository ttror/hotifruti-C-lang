...
![Tela da Balança](docs/images/telabalanca.jpg)
...
![Tela de Login](docs/images/telalogin.jpg)
...
![Menu Administrativo (ADMIN)](docs/images/telaadmin.jpg)
...
![Ponto de Venda (PDV)](docs/images/telapdv.jpg)
...
|--------|---------|-------|-----------|
| **PDV** | `pdv` | `pdv` | Acesso ao ponto de venda |
...
typedef struct {
    ...
    char tipo[MAX];                        // Tipo do produto (ex: Fruta, Legume)
    char descricao[MAX];                   // Descrição detalhada
    bool vendidoAGranela;                  // Flag para venda a granel
    double precoPorKilo;                   // Preço por quilo (se vendido a granel)
